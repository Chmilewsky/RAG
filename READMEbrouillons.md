...
grace a tout cela on inject les donner des chunk pertinent au llm afin qui puisse avoir un context supplementaire que la question en elle meme et de repondre a partir de sont context.
pour resumer on fait une extraction de donnee en relation avec la question et le prompt pour le llm devient question + donnee.
